...
public class Update extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vname=(String) s3.getAttribute("vname");
        String uname=(String) s3.getAttribute("uname");
        String date = request.getParameter("date");
        System.out.println("hello"+date);
        String comment = request.getParameter("comment");
        Class.forName("com.mysql.jdbc.Driver");
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/SE","root","root");
        String sql_stmt="insert into comments values('"+date+"','"+uname+"','"+vname+"','"+comment+"');";
